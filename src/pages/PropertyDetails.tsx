...
const mockProperty = {
  ...
  parking: 2,
  description:
    "This stunning 3-bedroom apartment offers breathtaking sea views and modern luxury living. Located in the prestigious Dubai Marina, the property features premium finishes, floor-to-ceiling windows, and access to world-class amenities including swimming pool, gym, and 24/7 security.",
  descriptionAr:
    "تقدم هذه الشقة المذهلة المكونة من 3 غرف نوم إطلالات خلابة على البحر ومعيشة عصرية فاخرة. تقع في مرسى دبي المرموق، وتتميز بتشطيبات راقية ونوافذ ممتدة من الأرض إلى السقف والوصول إلى مرافق عالمية المستوى بما في ذلك حمام السباحة والصالة الرياضية والأمن على مدار الساعة.",
  images: [
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="text-3xl font-bold text-primary">
                      {formatPrice(
                        mockProperty.price,
                        mockProperty.currency,
                        mockProperty.forSale
                      )}
                    </div>
                  </div>
