...
import { Building, Plus, Eye, MessageSquare, TrendingUp, Edit, Trash2 } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            {language === 'ar' ? 'إدارة عقاراتك ومراقبة الأداء' : 'Manage your properties and monitor performance'}
          </p>
        </div>
          ...
          <Card className="animate-fade-in">
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                {dashboardStats.activeListings} {language === 'ar' ? 'نشط' : 'active'}
              </p>
            </CardContent>
          </Card>
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Button variant="outline" className="flex items-center space-x-2 rtl:space-x-reverse">
              ...
              <span>{language === 'ar' ? 'عرض الإحصائيات' : 'View Analytics'}</span>
            </Button>
        ...
        <div>
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-semibold">{t('dashboard.recentProperties')}</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
            {recentProperties.map((property) => (
              <Card key={property.id} className="overflow-hidden animate-fade-in">
